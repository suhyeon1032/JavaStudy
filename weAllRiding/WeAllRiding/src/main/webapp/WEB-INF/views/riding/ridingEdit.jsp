...
<main>
	<div class="ridingViewContainer">
		<form method="post"
			...
			<ul>
				<h1 id="ridingViewTitle"></h1>
				<br>
				<br>
				<h2>제목</h2>
				<li><input type="text" name="ridingSubject" id="ridingSubject"
					value="${vo.ridingSubject }" /></li>
				<br>
				<h2>키워드</h2>
				<li><input type="text" name="ridingKeyword" id="ridingKeyword"
					value="${vo.ridingKeyword }"></input></li>
				<br>
				<br>
				...
				<li id="dateAll" style="color: black;">
					<h2 id="ridingViewTitle">일정</h2> <input type="date"
				...
				<li id=courseLevel style="color: black">
					<h2>난이도</h2> <select id="courseLevelsel" name="courseLevel"
					class="courseLevelsel" value="${vo.courseLevel }">
				...
				<li id="maxUser" style="color: black">
					<h2>참가인원</h2> <select id="maxUsersel" name="maxUsersel"
					class="maxUsersel">
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
				...
				<li><textarea name="ridingContent" id="ridingContent"
						style="min-height: 400px; width: 100%;">${vo.ridingContent }</textarea></li>
				...
				<hr>
				<li id="ridingEditBTN"><input type="submit" id="ridingwriteBtn"
					value="글 수정" /></li>
			</ul>
		</form>
	</div>
